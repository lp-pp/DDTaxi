package com.lp.ddtaxi.TabFragment;
...
import com.lp.ddtaxi.utils.DrivingRouteOverlay;
import com.lp.ddtaxi.utils.LogUtil;
import com.lp.ddtaxi.utils.PoiOverlay;
...
public class TabFragment3 extends BaseFragment implements
    ...
    private FloatingActionButton floating_locate_center;
    ...
    public void initData() {
        ...
        mCurrentMarker = BitmapDescriptorFactory.fromResource(R.drawable.icon_pin1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.floating_safety_center:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), floating_safety_center_url);
                break;
            ...
            case R.id.iv_bottom_sheet_item1:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url1);
                break;
            case R.id.iv_bottom_sheet_item2:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url2);
                break;
            case R.id.iv_bottom_sheet_item3:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url3);
                break;
            case R.id.iv_bottom_sheet_item4:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url4);
                break;
            case R.id.iv_bottom_sheet_item5:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url5);
                break;
            case R.id.iv_bottom_sheet_item6:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url6);
                break;
            case R.id.iv_bottom_sheet_item7:
                WebDetailActivityUtils.startDDInfoActivity(this.getActivity(), iv_bottom_sheet_item_url7);
                break;
        }
    }
