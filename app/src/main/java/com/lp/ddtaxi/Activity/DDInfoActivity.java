package com.lp.ddtaxi.Activity;
...
public class DDInfoActivity extends AppCompatActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
    private String TAG = DDInfoActivity.class.getSimpleName();
