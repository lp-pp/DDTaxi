package com.lp.ddtaxi.DriverLicenseRecognition;
...
/**
 * @className: LicenseOCRActivity
 * @author   : Created by lp
 * @e-mail   : 1049345904@qq.com
 * @date     : 2020/8/9 上午10：20
 * @version  : 1.0
 * @desc     : LicenseOCRActivity 调用 DigitImageProcessor 找到驾驶员证件照片的证件区域和数字区域，并且最终得到特征向量学习识别出数字
 */

public class LicenseOCRActivity extends AppCompatActivity implements View.OnClickListener {
    private String TAG = LicenseOCRActivity.class.getSimpleName();
